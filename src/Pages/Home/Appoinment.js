...
const Appoinment = () => {
    return (
        <div style={{ background: `url(${appionment})`, backgroundSize: "cover" }} className="mt-60 flex justify-center items-center lg:px-20 ">
            <div className="text-center flex-1 hidden lg:block">
                <img className='mt-[-110px] ' src={doctor} alt="" />
            </div>
            <div className='flex-1  text-white p-10 lg:p-0 md:p-20 '>
